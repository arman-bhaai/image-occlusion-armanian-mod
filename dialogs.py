...
def ioCritical(msgkey, title="Image Occlusion ArMOD Error", text="",
...
def ioAskUser(msgkey, title="Image Occlusion ArMOD", parent=None, text="",
...
def ioInfo(msgkey, title="Image Occlusion ArMOD", text="", parent=None,
...
def ioHelp(msgkey, title="Image Occlusion ArMOD Help",
           text="", parent=None):
